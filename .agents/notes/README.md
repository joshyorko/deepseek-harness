...
### Optional Chinese counterparts

A new or changed Agent Note does not require a Chinese counterpart. When translation is explicitly requested, a `.zh.md` counterpart mirrors its English sibling under the [optional translation workflow](../../docs/i18n/README.md); the machine-checked header tokens (`# Agent Note: ` and the `Status:` line) stay in English verbatim.
